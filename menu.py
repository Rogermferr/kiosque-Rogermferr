products = [
    ...
    },
    {
        ...
        "description": (
            ...
            " on old wooden background. "
            "forest wealth. rustic style. selective focus"
        ),
        "price": 27.35,
        "rating": 0,
    ...
    },
    {
        "_id": 30,
        "description": (
            "Glass jar with homemade granola and yogurt with nuts,"
            " raspberries and blackberries on"
            " wooden cutting board over"
            " white textile in day light"
        ),
        "price": 29.97,
        "rating": 3,
        "title": "Granola",
    ...
    },
    {
        ...
        "description": (
            ...
            " served with cocktail tube, green apple and"
            " baby spinach leaves over tin surface."
        ),
        "price": 17.68,
        "rating": 4,
    ...
    },
    {
        ...
        "description": (
            "Healthy breakfast."
            " berry crumble with fresh blueberries,"
            " raspberries, strawberries, almond,"
            " walnuts, pecans, yogurt,"
            " and mint in ceramic plates over"
            " white wooden surface, top view"
        ),
        "price": 21.01,
        "rating": 4,
    ...
    },
    {
        "_id": 31,
        "description": (
            "Glass of red strawberry smoothie with chia seeds,"
            " served with retro cocktail tube,"
            " fresh mint and strawberries over wooden table"
        ),
        "price": 25.26,
        "rating": 5,
    ...
    },
    {
        "_id": 40,
        "description": (
            "Italian ciabatta bread cut in slices"
            " on wooden chopping board with herbs,"
            " garlic and olives over dark grunge backdrop, top view"
        ),
        "price": 15.18,
        "rating": 1,
    ...
    },
    {
        "_id": 42,
        "description": (
            "Heap of whole and sliced lemons and limes with mint"
            " in vintage metal grid box over old wooden table"
            " with turquoise wooden background. dark rustic style."
        ),
        "price": 27.14,
        "rating": 2,
        "title": "Sliced lemons",
    ...
    },
    {
        "_id": 41,
        "description": (
            "Rustic healthy breakfast set. cooked buckwheat groats"
            " with milk and honey on dark grunge backdrop."
            " top view, copy space"
        ),
        "price": 21.32,
        "rating": 0,
    ...
    },
    {
        "_id": 45,
        "description": (
            "Healthy breakfast set. rice cereal or porridge with"
            " fresh strawberry, apricots, almond and honey over"
            " white rustic wood backdrop, top view, \x00"
        ),
        "price": 15.13,
        "rating": 3,
        "title": "Strawberries",
    ...
    },
    {
        "_id": 6,
        "description": (
            "Baking cake in rural kitchen - dough  recipe ingredients"
            " (eggs, flour, sugar) on vintage wooden table from above."
        ),
        "price": 11.14,
        "rating": 4,
        "title": "Baking cake",
    ...
    },
    {
        "_id": 50,
        "description": (
            "Peaches on branch with leaves and glasses with peach juice"
            " and limonade with ice cubes in aluminum tray"
            " over old metal table. dark rustic style. top view."
        ),
        "price": 25.62,
        "rating": 3,
    ...
    },
    {
        ...
        "description": (
            "Glass of red strawberry smoothie with chia seeds,"
            " served with retro cocktail tube,"
            " fresh mint and strawberries over dark background"
        ),
        "price": 28.86,
        "rating": 2,
